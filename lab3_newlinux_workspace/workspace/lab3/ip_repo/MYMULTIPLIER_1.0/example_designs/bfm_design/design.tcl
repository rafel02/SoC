proc create_ipi_design { offsetfile design_name } {
	...
	set MYMULTIPLIER_0 [ create_bd_cell -type ip -vlnv ttu.ee:user:MYMULTIPLIER:1.0 MYMULTIPLIER_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI ] [get_bd_intf_pins MYMULTIPLIER_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/ACLK] [get_bd_pins MYMULTIPLIER_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/ARESETN] [get_bd_pins MYMULTIPLIER_0/S00_AXI_ARESETN]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/MYMULTIPLIER_v1_0_tb_include.svh"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores ttu.ee:user:MYMULTIPLIER:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/MYMULTIPLIER_v1_0_tb.sv
