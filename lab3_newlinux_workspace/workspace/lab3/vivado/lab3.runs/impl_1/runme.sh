...
HD_PWD='/home/hasing/workspace/lab3/vivado/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_block_wrapper.tcl -notrace
