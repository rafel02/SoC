...
HD_PWD='/home/hasing/workspace/lab3/vivado/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3_block_wrapper.tcl
