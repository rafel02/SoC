...
HD_PWD='/home/hasing/Workspace/soc_project/vivado/lab4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_soc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab4_soc_wrapper.tcl -notrace
