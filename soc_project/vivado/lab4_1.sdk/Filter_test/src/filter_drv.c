...
int main(){
    ...
    FILTER_IIR_mWriteReg(XPAR_FILTER_IIR_0_S00_AXI_BASEADDR, FILTER_IIR_S00_AXI_SLV_REG17_OFFSET, 0x00000001 );
    FILTER_IIR_mWriteReg(XPAR_FILTER_IIR_0_S00_AXI_BASEADDR, FILTER_IIR_S00_AXI_SLV_REG18_OFFSET, 0x00000000 );
    FILTER_IIR_mWriteReg(XPAR_FILTER_IIR_0_S00_AXI_BASEADDR, FILTER_IIR_S00_AXI_SLV_REG19_OFFSET, 0x00000001 );
