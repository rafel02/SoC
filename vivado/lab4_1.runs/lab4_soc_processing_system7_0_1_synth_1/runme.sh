...
HD_PWD='/home/hasing/Workspace/soc_project/vivado/lab4_1.runs/lab4_soc_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_soc_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4_soc_processing_system7_0_1.tcl
