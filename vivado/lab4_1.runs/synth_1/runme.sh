...
HD_PWD='/home/hasing/Workspace/soc_project/vivado/lab4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_soc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4_soc_wrapper.tcl
